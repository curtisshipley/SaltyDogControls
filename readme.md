***SaltyDogControls*** is a library of Xamarin Forms controls that renders xaml/ui at rutime, providing more flexible UIs without having to rely workarounds such as toggling IsVisible on various
